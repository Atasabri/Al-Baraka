        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HasEnglish = table.Column<bool>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(nullable: false),
                    Phone = table.Column<string>(nullable: false),
                    YourComment = table.Column<string>(nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Comments_Services_Service_ID",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Service_Analyzes", x => x.ID);
                    table.ForeignKey(
                        name: "FK_Service_Analyzes_Services_Service_ID",
                        column: x => x.Service_ID,
                        principalTable: "Services",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Comments_Service_ID",
                table: "Comments",
                column: "Service_ID");

            migrationBuilder.CreateIndex(
                name: "IX_Service_Analyzes_Service_ID",
                table: "Service_Analyzes",
                column: "Service_ID");
        }
